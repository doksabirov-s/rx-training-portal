...
pdf.body_text(
    ...
    "эффективность и безопасность MPFF (диосмин + гесперидин)\n"
...
pdf.section_title("MPFF при геморрое: систематический обзор и метаанализ")
pdf.bold_text("Авторы:")
...
pdf.green_box(
    'Вывод: «MPFF улучшает наиболее важные признаки и симптомы\n'
...
pdf.sub_title("Значимость")
pdf.body_text(
    "Единственный VAD с полным систематическим обзором и метаанализом\n"
...
pdf.section_title("Эффективность и переносимость MPFF при геморрое: систематический обзор и метаанализ")
pdf.bold_text("Авторы:")
...
pdf.body_text(
    "MPFF значительно улучшает кровотечение:\n"
    "RR 1.46 (95% CI: 1.10–1.93; p = 0.008)."
)

pdf.green_box(
    "Вывод: MPFF (диосмин с гесперидином) статистически значимо\n"
...
pdf.body_text(
    "MPFF (микронизированный диосмин с гесперидином) —\n"
    ...
    "позиции MPFF в международных рекомендациях."
)
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "MPFF (диосмин с гесперидином) — веноактивный препарат\n"
...
pdf.section_title("Улучшение ведения ХВН с помощью MPFF: от клинических исследований к реальной практике")
pdf.bold_text("Авторы:")
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "• MPFF высоко рекомендуется в международных гайдлайнах\n"
    "  по ведению ХВН\n\n"
    "• MPFF является ЕДИНСТВЕННЫМ веноактивным препаратом,\n"
...
pdf.section_title("Новые перспективы MPFF при хронических заболеваниях вен")
pdf.bold_text("Авторы:")
...
pdf.body_text(
    ...
    "MPFF (диосмин с гесперидином) для:\n\n"
    "• Уменьшения симптомов хронических заболеваний вен\n"
    "• Улучшения качества жизни пациентов\n\n"
    "Обзор обобщает новые перспективы применения MPFF\n"
...
pdf.section_title("MPFF при хронической венозной недостаточности с фокусом на посттромботический синдром")
pdf.bold_text("Авторы:")
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "MPFF (диосмин с гесперидином) улучшает клинические\n"
...
pdf.section_title("Есть ли разница в клинической эффективности диосмина и MPFF при ХВН?")
pdf.bold_text("Авторы:")
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "• Подтверждает, что MPFF имеет рекомендацию 1B\n"
    ...
    "  и микронизированной комбинацией диосмин + гесперидин (MPFF)\n\n"
...
pdf.sub_title("Рекомендации по веноактивным препаратам (VAD)")
pdf.body_text(
    "• MPFF (диосмин с гесперидином) имеет НАИВЫСШУЮ степень\n"
...
pdf.green_box(
    "MPFF — рекомендация 1B (самая сильная среди всех VAD)\n"
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "Гайдлайны отдают предпочтение MPFF (диосмин с гесперидином)\n"
...
pdf.sub_title("Ключевые данные")
pdf.body_text(
    "Веноактивные препараты (включая MPFF — диосмин с гесперидином)\n"
