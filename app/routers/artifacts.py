...
async def _run_extended_slides(
    ...
    part_labels = [
        (
            f"ЧАСТЬ 1 из {parts}. "
            "Охвати ТОЛЬКО: механизм действия, фармакокинетику, фармакодинамику, "
            "клинические исследования, доказательную базу эффективности и безопасности. "
            "НЕ включай схемы дозирования и клинические случаи — они будут в следующей части. "
            "Язык презентации: русский."
        ),
        (
            f"ЧАСТЬ 2 из {parts}. Это ПРОДОЛЖЕНИЕ, а НЕ повтор части 1. "
            "Охвати ТОЛЬКО то, чего НЕ было в части 1: показания и противопоказания, "
            "схемы дозирования, нежелательные явления, клинические случаи, "
            "практические рекомендации для врачей. "
            "Язык презентации: русский."
        ),
        (
            f"ЧАСТЬ 3 из {parts}. Продолжение, без повтора частей 1 и 2. "
            "Охвати ТОЛЬКО: особые группы пациентов, лекарственные взаимодействия, "
            "сравнение с препаратами-конкурентами, место в клинических рекомендациях. "
            "Язык презентации: русский."
        ),
        (
            f"ЧАСТЬ 4 из {parts}. Заключительная часть, без повтора предыдущих. "
            "Охвати ТОЛЬКО: новейшие данные исследований, перспективы применения, "
            "фармакоэкономику, резюме для врачей и ключевые выводы по всей теме. "
            "Язык презентации: русский."
        ),
    ]
    ...
    try:
        for i in range(parts):
            ...
            instructions = topic_prefix + part_labels[i % len(part_labels)]
